...
import StepDetails from './process/StepDetails';
import DocumentList from './process/DocumentList';
import PaymentList from './process/PaymentList';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-4xl h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'documents' && (
            <DocumentList process={process} />
          )}

          {activeTab === 'payments' && (
            <PaymentList process={process} />
          )}
